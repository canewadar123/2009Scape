	...
	public boolean handle(int interfaceId, int buttonId) {
		if (player.getSavedData().getGlobalData().isWydinEmployee()) {
			...
			case 1:
				switch (buttonId) {
				case 1:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Yes, can I work out front now?");
					stage = 10;
					break;
				case 2:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Yes, are you going to pay me yet?");
					stage = 20;
					break;
				case 3:
				...
				break;
			case 10:
				interpreter.sendDialogues(557, FacialExpression.HALF_GUILTY, "No, I'm the one who works here.");
				stage = 11;
				break;
			case 11:
				end();
				break;
			case 20:
				interpreter.sendDialogues(557, FacialExpression.HALF_GUILTY, "Umm... No, not yet.");
				stage = 21;
				break;
			case 21:
				end();
			...
			case 30:
				...
				break;
			case 31:
				interpreter.sendDialogues(557, FacialExpression.HALF_GUILTY, "Ah well, it'll give you something to do, won't it.");
				stage = 32;
				break;
			case 32:
				end();
			...
			case 1:
				...
				case 2:
					...
					break;
				case 3:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "What can you recommend?");
					stage = 30;
					break;
				case 4:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Can I get a job here?");
					stage = 40;
					break;
				}
				break;
